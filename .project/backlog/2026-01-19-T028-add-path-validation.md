...
- [ ] Path traversal blocked:
  ...
  - [ ] Symlinks to /etc or /tmp
- [ ] No false positives (valid paths work)
- [ ] Defense in depth (multiple checks)

### Performance
- [ ] Validation overhead minimal (<1ms per path)
- [ ] No noticeable slowdown

### Code Quality
- [ ] TypeScript strict mode
- [ ] Clear error messages
- [ ] Proper error types (SecurityError)
- [ ] Linting passes

### Documentation
- [ ] Time logged
- [ ] JSDoc on validator functions
- [ ] SECURITY.md updated (if exists)
- [ ] CONTRIBUTING.md mentions security
...
- [ ] Convention: `security: add explicit path traversal validation`
- [ ] No conflicts
