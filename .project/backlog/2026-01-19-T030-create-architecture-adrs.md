...
**Success:**
- [ ] 3-5 ADRs created for major architectural decisions
- [ ] ADRs follow standard format
- [ ] Rationale and alternatives documented
- [ ] Located in `.project/decisions/`
- [ ] Referenced from relevant code/docs
...
**ADR Template:** Use `.project/_templates/adr-template.md`
